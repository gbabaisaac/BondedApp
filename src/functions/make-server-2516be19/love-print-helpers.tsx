...
export async function getFirstQuestion(userProfile: any): Promise<any> {
  if (!userProfile || !userProfile.name) {
    throw new Error('User profile is required with a name');
  }
...
User Info: ${userProfile.name || 'Student'}, ${userProfile.major || 'Undecided'}, ${userProfile.year || 'Freshman'}
...
User Info: ${quizSession.userProfile?.name || 'Student'}, ${quizSession.userProfile?.major || 'Undecided'}, ${quizSession.userProfile?.year || 'Freshman'}
